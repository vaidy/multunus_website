...
<img src='http://new.multunus.com/wordpress/wp-content/gallery/avi-manipulators/image_distorter3.png' alt='Image Distorter' class='ngg-singlepic ngg-left' />This app allows the user to load an image and then apply a variety of different effects on the image. These effects include  smearing, growing, shrinking etc within defined spaces on the image.
