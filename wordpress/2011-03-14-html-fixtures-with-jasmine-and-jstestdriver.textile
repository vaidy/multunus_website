...
*Update:* I've created a gem using which you can achieve the same. Click <a href="https://github.com/multunus/js_fixtures">here</a> for the same.

*<span style="text-decoration: underline;">Generate the fixtures</span>*
...
<span style="text-decoration: underline;">*Load the fixtures in JS tests*</span>
