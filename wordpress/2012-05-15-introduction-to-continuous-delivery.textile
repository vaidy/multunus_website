...
h3. *<span style="text-decoration: underline;">What is Continuous Delivery</span>*
...
h3. *Bottlenecks for Continuous Delivery*
...
<div>
h3. Continuous Delivery to the rescue
...
<div>A central pattern of Continuous Delivery is called the _*Deployment pipeline - *_an automated implementation of the application's build, deploy, test and release process. The following shows a sample deployment pipeline:</div>
<p style="text-align: center;"><img class="aligncenter" style="border: none;" src="https://s3.amazonaws.com/multunus-cdimages/pipeline.png" alt="Deployment Pipeline" width="549" height="189" />
...
h4. <span style="text-decoration: underline;">References</span>
